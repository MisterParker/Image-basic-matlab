...
% TASK 3 - Performing smoothing and sharpening operations
...
figure(1);
subplot(2,5,1),imshow(i1),title('Orignal Plane Image');
...
subplot(2,5,6),imshow(i1),title('Orignal Plane Image');
...
figure(2);
subplot(2,5,1),imshow(i2),title('Orignal House Image');
...
subplot(2,5,6),imshow(i2),title('Orignal House Image');
