...
%Greyscale img
i1 = imread('/Users/akshaygugale/Downloads/sem3-VIT/CSE4019/project/aerial.jpg');
[m1 n1] = size(i1);
%disp(i1);
...
%Coloured img
i2 = imread('/Users/akshaygugale/Downloads/sem3-VIT/CSE4019/project/lenna_coloured.jpg');
[m2 n2 o2] = size(i2);
%disp(i2);
disp('Coloured Image');
